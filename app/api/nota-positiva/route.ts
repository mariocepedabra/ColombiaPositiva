      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; color: #1c1c1c;">
          ...
          <div style="padding: 32px; border: 1px solid #e8e8e4; border-top: none;">
            ...
            <div style="border-left: 3px solid #006039; padding-left: 16px; margin: 16px 0;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 24px;">
              ...
              <tr>
                ...
                <td style="font-size: 14px; font-family: sans-serif; padding: 8px 0; border-top: 1px solid #e8e8e4;"><a href="mailto:${email}" style="color: #006039;">${email}</a></td>
              </tr>` : ''}
              ${region ? `
              <tr>
              ...
              <tr>
                ...
                <td style="font-size: 14px; font-family: sans-serif; padding: 8px 0; border-top: 1px solid #e8e8e4;"><a href="${mediaUrl}" style="color: #006039; word-break: break-all;">${mediaUrl}</a></td>
              </tr>` : ''}
            </table>

            <div style="margin-top: 32px; text-align: center;">
              <a href="https://colombiapositiva.com/admin/notas-positivas"
                style="display: inline-block; background: #006039; color: white; font-family: sans-serif; font-size: 12px; font-weight: bold; text-transform: uppercase; letter-spacing: 2px; padding: 12px 24px; text-decoration: none;">
                Ver en el panel →
              </a>
            </div>
          </div>
