      ...
      <article className="group flex gap-4 py-4 border-b border-gris-200 last:border-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <Link href={`/articulo/${article.slug}`}>
            <h3 className="font-heading font-700 text-tinta text-sm leading-snug mt-0.5 line-clamp-3 group-hover:text-verde transition-colors">
              {article.title}
            </h3>
          </Link>
  ...
  if (variant === "minimal") {
    return (
      <article className="group py-3 border-b border-gris-200 last:border-0">
        ...
        <Link href={`/articulo/${article.slug}`}>
          <h3 className="font-heading font-600 text-tinta text-sm leading-snug mt-0.5 line-clamp-2 group-hover:text-verde transition-colors">
            {article.title}
          </h3>
        </Link>
    ...
    <article className="group flex flex-col h-full">
      ...
      <div className="flex-1 pt-3 flex flex-col">
        ...
        <Link href={`/articulo/${article.slug}`} className="flex-1">
          <h3 className="font-heading font-700 text-tinta text-base leading-snug mb-2 line-clamp-3 group-hover:text-verde transition-colors">
            {article.title}
          </h3>
