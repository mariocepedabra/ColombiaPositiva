  ...
  return (
    <article className={`group flex-1 p-4 flex flex-col ${withBorder ? 'border-b border-gris-200' : ''}`}>
      ...
      <Link href={`/articulo/${article.slug}`}>
        <h3 className="font-heading font-700 text-tinta text-sm leading-snug line-clamp-4 group-hover:text-titulo transition-colors">
          {article.title}
        </h3>
      </Link>
    ...
    <>
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <Link href={`/articulo/${article.slug}`} className="group flex-1">
          <h2 className="font-heading font-900 text-tinta text-2xl md:text-3xl leading-tight mb-3 group-hover:text-titulo transition-colors line-clamp-3">
            {article.title}
          </h2>
        </Link>
